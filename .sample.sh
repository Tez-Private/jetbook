...
echo "#### GET /api/v1/users/1 ####" && curl -X GET -H $ENDPOINT/users/1 && echo "\n"
...
echo "#### GET /api/v1/books/1 ####" && curl -X GET $ENDPOINT/books/9784295004806 && echo "\n"
...
echo "#### GET /api/v1/rents/1 ####" && curl -X GET $ENDPOINT/rents/1 && echo "\n"
echo "#### PATCH /api/v1/rents/return ####" && curl -X PATCH -H "Content-Type: application/json" -d '{"id": "1"}' $ENDPOINT/rents/return && echo "\n"
