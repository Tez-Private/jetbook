...
echo "#### GET /api/v1/users/:id ####" && curl -X GET -H $ENDPOINT/users/1 && echo "\n"
echo "#### PATCH /api/v1/users/:id ####" && curl -X PATCH -H "Content-Type: application/json" -d '{"username": "test", "pass": "pass"}' $ENDPOINT/users/1 && echo "\n"
...
echo "#### GET /api/v1/books/:id ####" && curl -X GET $ENDPOINT/books/9784295004806 && echo "\n"
...
echo "#### GET /api/v1/rents/:id ####" && curl -X GET $ENDPOINT/rents/1 && echo "\n"
echo "#### PATCH /api/v1/rents/:id/return ####" && curl -X PATCH -H "Content-Type: application/json" -d '{"id": "1"}' $ENDPOINT/rents/1/return && echo "\n"
